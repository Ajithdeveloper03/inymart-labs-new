...
for (const relPath of filesToProcess) {
  ...
  // Extract Link text
  let linkMatch = content.match(/See Our[\s\S]*?Action/i);
  let linkText = linkMatch ? linkMatch[0] : 'See Our Process in Action';
