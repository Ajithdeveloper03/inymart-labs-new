...
export function WebDevWhoThisIsFor() {
  const points = [
    {
      title: null,
      text: `Businesses without a website, or with one that feels outdated`,
      icon: Users,
    ...
    {
      title: null,
      text: `Businesses whose website is slow, hard to use, or not mobile-friendly`,
      icon: Search,
    ...
    {
      title: null,
      text: `Ecommerce businesses wanting a smoother, more reliable online store`,
      icon: AlertCircle,
    ...
    {
      title: null,
      text: `Any business planning to invest in SEO or ads and needing a website that can support it`,
      icon: TrendingUp,
