            ...
            <Reveal className="h-full">
              <div className="relative w-full h-full min-h-[400px] overflow-hidden rounded-t-[32px] rounded-br-[32px] rounded-bl-[120px] sm:rounded-bl-[160px] lg:rounded-bl-[200px] shadow-[0_20px_60px_rgb(0,0,0,0.1)]">
                <img 
                  ...
                  alt="Digital marketing team planning a local business growth campaign, with a strategist explaining Reels, Meta lead ads, WhatsApp conversions, retargeting, and campaign performance metrics." 
