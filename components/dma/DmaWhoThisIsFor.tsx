...
export function DmaWhoThisIsFor() {
  const points = [
    {
      title: null,
      text: `Businesses wanting a single team to manage their entire online presence`,
      icon: Users,
    ...
    {
      title: null,
      text: `Businesses currently juggling multiple vendors without clear coordination`,
      icon: Search,
    ...
    {
      title: null,
      text: `Any business unsure which marketing channels actually deserve their budget`,
      icon: TrendingUp,
