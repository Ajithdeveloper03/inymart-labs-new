...
export function LocalSeoWhoThisIsFor() {
  const points = [
    {
      title: null,
      text: `Local shops and service businesses wanting more calls and walk-ins`,
      icon: Users,
    ...
    {
      title: null,
      text: `Businesses with multiple branches across Tamil Nadu`,
      icon: Search,
